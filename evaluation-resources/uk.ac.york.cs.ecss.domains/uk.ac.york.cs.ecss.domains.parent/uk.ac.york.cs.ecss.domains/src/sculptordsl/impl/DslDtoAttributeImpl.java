...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dsl Dto Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getType <em>Type</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isAssertFalse <em>Assert False</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getAssertFalseMessage <em>Assert False Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isAssertTrue <em>Assert True</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getAssertTrueMessage <em>Assert True Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isCreditCardNumber <em>Credit Card Number</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getCreditCardNumberMessage <em>Credit Card Number Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getDigits <em>Digits</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isEmail <em>Email</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getEmailMessage <em>Email Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isFuture <em>Future</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getFutureMessage <em>Future Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isPast <em>Past</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getPastMessage <em>Past Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getMax <em>Max</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getMin <em>Min</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getDecimalMax <em>Decimal Max</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getDecimalMin <em>Decimal Min</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#isNotBlank <em>Not Blank</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getNotBlankMessage <em>Not Blank Message</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getRange <em>Range</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getLength <em>Length</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getScriptAssert <em>Script Assert</em>}</li>
 *   <li>{@link sculptordsl.impl.DslDtoAttributeImpl#getUrl <em>Url</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DslDtoAttributeImpl extends DslDtoPropertyImpl implements DslDtoAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return SculptordslPackage.Literals.DSL_DTO_ATTRIBUTE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__TYPE, oldType, type));
	}
	...
	public void setAssertFalse(boolean newAssertFalse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_FALSE, oldAssertFalse, assertFalse));
	}
	...
	public void setAssertFalseMessage(String newAssertFalseMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_FALSE_MESSAGE, oldAssertFalseMessage, assertFalseMessage));
	}
	...
	public void setAssertTrue(boolean newAssertTrue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_TRUE, oldAssertTrue, assertTrue));
	}
	...
	public void setAssertTrueMessage(String newAssertTrueMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_TRUE_MESSAGE, oldAssertTrueMessage, assertTrueMessage));
	}
	...
	public void setCreditCardNumber(boolean newCreditCardNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__CREDIT_CARD_NUMBER, oldCreditCardNumber, creditCardNumber));
	}
	...
	public void setCreditCardNumberMessage(String newCreditCardNumberMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__CREDIT_CARD_NUMBER_MESSAGE, oldCreditCardNumberMessage, creditCardNumberMessage));
	}
	...
	public void setDigits(String newDigits) {
		...
		digits = newDigits;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__DIGITS, oldDigits, digits));
	}
	...
	public void setEmail(boolean newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__EMAIL, oldEmail, email));
	}
	...
	public void setEmailMessage(String newEmailMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__EMAIL_MESSAGE, oldEmailMessage, emailMessage));
	}
	...
	public void setFuture(boolean newFuture) {
		...
		future = newFuture;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__FUTURE, oldFuture, future));
	}
	...
	public void setFutureMessage(String newFutureMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__FUTURE_MESSAGE, oldFutureMessage, futureMessage));
	}
	...
	public void setPast(boolean newPast) {
		...
		past = newPast;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__PAST, oldPast, past));
	}
	...
	public void setPastMessage(String newPastMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__PAST_MESSAGE, oldPastMessage, pastMessage));
	}
	...
	public void setMax(String newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__MAX, oldMax, max));
	}
	...
	public void setMin(String newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__MIN, oldMin, min));
	}
	...
	public void setDecimalMax(String newDecimalMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__DECIMAL_MAX, oldDecimalMax, decimalMax));
	}
	...
	public void setDecimalMin(String newDecimalMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__DECIMAL_MIN, oldDecimalMin, decimalMin));
	}
	...
	public void setNotBlank(boolean newNotBlank) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__NOT_BLANK, oldNotBlank, notBlank));
	}
	...
	public void setNotBlankMessage(String newNotBlankMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__NOT_BLANK_MESSAGE, oldNotBlankMessage, notBlankMessage));
	}
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__PATTERN, oldPattern, pattern));
	}
	...
	public void setRange(String newRange) {
		...
		range = newRange;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__RANGE, oldRange, range));
	}
	...
	public void setLength(String newLength) {
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__LENGTH, oldLength, length));
	}
	...
	public void setScriptAssert(String newScriptAssert) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__SCRIPT_ASSERT, oldScriptAssert, scriptAssert));
	}
	...
	public void setUrl(String newUrl) {
		...
		url = newUrl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SculptordslPackage.DSL_DTO_ATTRIBUTE__URL, oldUrl, url));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__TYPE:
				return getType();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_FALSE:
				return isAssertFalse();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_FALSE_MESSAGE:
				return getAssertFalseMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_TRUE:
				return isAssertTrue();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__ASSERT_TRUE_MESSAGE:
				return getAssertTrueMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__CREDIT_CARD_NUMBER:
				return isCreditCardNumber();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__CREDIT_CARD_NUMBER_MESSAGE:
				return getCreditCardNumberMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__DIGITS:
				return getDigits();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__EMAIL:
				return isEmail();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__EMAIL_MESSAGE:
				return getEmailMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__FUTURE:
				return isFuture();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__FUTURE_MESSAGE:
				return getFutureMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__PAST:
				return isPast();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__PAST_MESSAGE:
				return getPastMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__MAX:
				return getMax();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__MIN:
				return getMin();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__DECIMAL_MAX:
				return getDecimalMax();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__DECIMAL_MIN:
				return getDecimalMin();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__NOT_BLANK:
				return isNotBlank();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__NOT_BLANK_MESSAGE:
				return getNotBlankMessage();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__PATTERN:
				return getPattern();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__RANGE:
				return getRange();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__LENGTH:
				return getLength();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__SCRIPT_ASSERT:
				return getScriptAssert();
			case SculptordslPackage.DSL_DTO_ATTRIBUTE__URL:
				return getUrl();
		}
