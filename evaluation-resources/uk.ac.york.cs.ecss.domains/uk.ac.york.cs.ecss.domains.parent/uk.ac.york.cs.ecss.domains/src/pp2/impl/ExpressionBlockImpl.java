 ...
 * </p>
 * <ul>
 *   <li>{@link pp2.impl.ExpressionBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ExpressionBlockImpl extends ExpressionImpl implements ExpressionBlock {
	...
	protected EClass eStaticClass() {
		return Pp2Package.Literals.EXPRESSION_BLOCK;
	}
	...
	public EList<Expression> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Expression>(Expression.class, this, Pp2Package.EXPRESSION_BLOCK__STATEMENTS);
		}
		return statements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp2Package.EXPRESSION_BLOCK__STATEMENTS:
