 ...
 * </p>
 * <ul>
 *   <li>{@link pp2.impl.VirtualNameOrReferenceImpl#getValue <em>Value</em>}</li>
 *   <li>{@link pp2.impl.VirtualNameOrReferenceImpl#isExported <em>Exported</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualNameOrReferenceImpl extends LiteralExpressionImpl implements VirtualNameOrReference {
	...
	protected EClass eStaticClass() {
		return Pp2Package.Literals.VIRTUAL_NAME_OR_REFERENCE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp2Package.VIRTUAL_NAME_OR_REFERENCE__VALUE, oldValue, value));
	}
	...
	public void setExported(boolean newExported) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp2Package.VIRTUAL_NAME_OR_REFERENCE__EXPORTED, oldExported, exported));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pp2Package.VIRTUAL_NAME_OR_REFERENCE__VALUE:
				return getValue();
			case Pp2Package.VIRTUAL_NAME_OR_REFERENCE__EXPORTED:
				return isExported();
		}
