 ...
 * </p>
 * <ul>
 *   <li>{@link pp2.impl.ResourceExpressionImpl#getResourceExpr <em>Resource Expr</em>}</li>
 *   <li>{@link pp2.impl.ResourceExpressionImpl#getResourceData <em>Resource Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceExpressionImpl extends ExpressionImpl implements ResourceExpression {
	...
	protected EClass eStaticClass() {
		return Pp2Package.Literals.RESOURCE_EXPRESSION;
	}
	...
	public NotificationChain basicSetResourceExpr(Expression newResourceExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pp2Package.RESOURCE_EXPRESSION__RESOURCE_EXPR, oldResourceExpr, newResourceExpr);
	...
	public void setResourceExpr(Expression newResourceExpr) {
		if (newResourceExpr != resourceExpr) {
			...
			if (resourceExpr != null)
				msgs = ((InternalEObject)resourceExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pp2Package.RESOURCE_EXPRESSION__RESOURCE_EXPR, null, msgs);
			if (newResourceExpr != null)
				msgs = ((InternalEObject)newResourceExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pp2Package.RESOURCE_EXPRESSION__RESOURCE_EXPR, null, msgs);
			msgs = basicSetResourceExpr(newResourceExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp2Package.RESOURCE_EXPRESSION__RESOURCE_EXPR, newResourceExpr, newResourceExpr));
	}
	...
	public EList<ResourceBody> getResourceData() {
		if (resourceData == null) {
			resourceData = new EObjectContainmentEList<ResourceBody>(ResourceBody.class, this, Pp2Package.RESOURCE_EXPRESSION__RESOURCE_DATA);
		}
		return resourceData;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp2Package.RESOURCE_EXPRESSION__RESOURCE_EXPR:
				return basicSetResourceExpr(null, msgs);
			case Pp2Package.RESOURCE_EXPRESSION__RESOURCE_DATA:
