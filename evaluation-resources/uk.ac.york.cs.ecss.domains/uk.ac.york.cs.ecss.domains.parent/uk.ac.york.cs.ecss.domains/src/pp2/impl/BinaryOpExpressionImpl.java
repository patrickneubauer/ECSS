 ...
 * </p>
 * <ul>
 *   <li>{@link pp2.impl.BinaryOpExpressionImpl#getOpName <em>Op Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BinaryOpExpressionImpl extends BinaryExpressionImpl implements BinaryOpExpression {
	...
	protected EClass eStaticClass() {
		return Pp2Package.Literals.BINARY_OP_EXPRESSION;
	}
	...
	public void setOpName(String newOpName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp2Package.BINARY_OP_EXPRESSION__OP_NAME, oldOpName, opName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pp2Package.BINARY_OP_EXPRESSION__OP_NAME:
				return getOpName();
		}
