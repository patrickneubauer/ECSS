 ...
 * @generated
 */
public class Pp2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Pp2Package.PUPPET_MANIFEST: {
			...
			case Pp2Package.EXPORTED_COLLECT_QUERY: {
			...
			case Pp2Package.HOST_CLASS_DEFINITION: {
				...
				if (result == null) result = caseExpressionBlock(hostClassDefinition);
				if (result == null) result = caseExpression(hostClassDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Pp2Package.DEFINITION: {
				Definition definition = (Definition)theEObject;
				T result = caseDefinition(definition);
				if (result == null) result = caseExpressionBlock(definition);
				if (result == null) result = caseExpression(definition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Pp2Package.DEFINITION_ARGUMENT_LIST: {
			...
			case Pp2Package.LITERAL_NAME_OR_REFERENCE: {
			...
			case Pp2Package.RESOURCE_EXPRESSION: {
			...
			case Pp2Package.IMPORT_EXPRESSION: {
			...
			case Pp2Package.LITERAL_DEFAULT: {
			...
			case Pp2Package.VARIABLE_EXPRESSION: {
			...
			case Pp2Package.RELATIONSHIP_EXPRESSION: {
			...
			case Pp2Package.ASSIGNMENT_EXPRESSION: {
			...
			case Pp2Package.APPEND_EXPRESSION: {
			...
			case Pp2Package.AND_EXPRESSION: {
			...
			case Pp2Package.RELATIONAL_EXPRESSION: {
			...
			case Pp2Package.EQUALITY_EXPRESSION: {
			...
			case Pp2Package.SHIFT_EXPRESSION: {
			...
			case Pp2Package.ADDITIVE_EXPRESSION: {
			...
			case Pp2Package.MULTIPLICATIVE_EXPRESSION: {
			...
			case Pp2Package.MATCHING_EXPRESSION: {
			...
			case Pp2Package.COLLECT_EXPRESSION: {
			...
			case Pp2Package.SELECTOR_EXPRESSION: {
			...
			case Pp2Package.SELECTOR_ENTRY: {
			...
			case Pp2Package.BINARY_OP_EXPRESSION: {
			...
			case Pp2Package.BINARY_EXPRESSION: {
			...
			case Pp2Package.PARAMETERIZED_EXPRESSION: {
			...
			case Pp2Package.UNARY_MINUS_EXPRESSION: {
			...
			case Pp2Package.UNARY_NOT_EXPRESSION: {
			...
			case Pp2Package.EXPRESSION_BLOCK: {
			...
			case Pp2Package.ELSE_EXPRESSION: {
			...
			case Pp2Package.ELSE_IF_EXPRESSION: {
				...
				if (result == null) result = caseExpressionBlock(elseIfExpression);
				if (result == null) result = caseExpression(elseIfExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Pp2Package.VIRTUAL_NAME_OR_REFERENCE: {
			...
			case Pp2Package.PARENTHESISED_EXPRESSION: {
			...
			case Pp2Package.DOUBLE_QUOTED_STRING: {
			...
			case Pp2Package.SINGLE_QUOTED_STRING: {
			...
			case Pp2Package.STRING_EXPRESSION: {
			...
			case Pp2Package.UNQUOTED_STRING: {
			...
			case Pp2Package.NAMED_ACCESS_EXPRESSION: {
			...
			case Pp2Package.WITH_LAMBDA_EXPRESSION: {
			...
			case Pp2Package.SEPARATOR_EXPRESSION: {
