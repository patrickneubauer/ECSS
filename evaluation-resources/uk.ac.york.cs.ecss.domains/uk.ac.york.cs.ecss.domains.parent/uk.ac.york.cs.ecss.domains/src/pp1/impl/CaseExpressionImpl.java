 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.CaseExpressionImpl#getSwitchExpr <em>Switch Expr</em>}</li>
 *   <li>{@link pp1.impl.CaseExpressionImpl#getCases <em>Cases</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CaseExpressionImpl extends ExpressionImpl implements CaseExpression {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.CASE_EXPRESSION;
	}
	...
	public NotificationChain basicSetSwitchExpr(Expression newSwitchExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pp1Package.CASE_EXPRESSION__SWITCH_EXPR, oldSwitchExpr, newSwitchExpr);
	...
	public void setSwitchExpr(Expression newSwitchExpr) {
		if (newSwitchExpr != switchExpr) {
			...
			if (switchExpr != null)
				msgs = ((InternalEObject)switchExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pp1Package.CASE_EXPRESSION__SWITCH_EXPR, null, msgs);
			if (newSwitchExpr != null)
				msgs = ((InternalEObject)newSwitchExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pp1Package.CASE_EXPRESSION__SWITCH_EXPR, null, msgs);
			msgs = basicSetSwitchExpr(newSwitchExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.CASE_EXPRESSION__SWITCH_EXPR, newSwitchExpr, newSwitchExpr));
	}
	...
	public EList<Case> getCases() {
		if (cases == null) {
			cases = new EObjectContainmentEList<Case>(Case.class, this, Pp1Package.CASE_EXPRESSION__CASES);
		}
		return cases;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.CASE_EXPRESSION__SWITCH_EXPR:
				return basicSetSwitchExpr(null, msgs);
			case Pp1Package.CASE_EXPRESSION__CASES:
