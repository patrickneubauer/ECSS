 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.LiteralListImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralListImpl extends LiteralExpressionImpl implements LiteralList {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.LITERAL_LIST;
	}
	...
	public EList<Expression> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Expression>(Expression.class, this, Pp1Package.LITERAL_LIST__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.LITERAL_LIST__ELEMENTS:
