 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.JavaLambdaImpl#isFarrow <em>Farrow</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaLambdaImpl extends LambdaImpl implements JavaLambda {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.JAVA_LAMBDA;
	}
	...
	public void setFarrow(boolean newFarrow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.JAVA_LAMBDA__FARROW, oldFarrow, farrow));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pp1Package.JAVA_LAMBDA__FARROW:
				return isFarrow();
		}
