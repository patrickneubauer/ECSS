 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.IfExpressionImpl#getCondExpr <em>Cond Expr</em>}</li>
 *   <li>{@link pp1.impl.IfExpressionImpl#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link pp1.impl.IfExpressionImpl#getElseStatement <em>Else Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfExpressionImpl extends ExpressionImpl implements IfExpression {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.IF_EXPRESSION;
	}
	...
	public NotificationChain basicSetCondExpr(Expression newCondExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pp1Package.IF_EXPRESSION__COND_EXPR, oldCondExpr, newCondExpr);
	...
	public void setCondExpr(Expression newCondExpr) {
		if (newCondExpr != condExpr) {
			...
			if (condExpr != null)
				msgs = ((InternalEObject)condExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pp1Package.IF_EXPRESSION__COND_EXPR, null, msgs);
			if (newCondExpr != null)
				msgs = ((InternalEObject)newCondExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pp1Package.IF_EXPRESSION__COND_EXPR, null, msgs);
			msgs = basicSetCondExpr(newCondExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.IF_EXPRESSION__COND_EXPR, newCondExpr, newCondExpr));
	}
	...
	public EList<Expression> getThenStatements() {
		if (thenStatements == null) {
			thenStatements = new EObjectContainmentEList<Expression>(Expression.class, this, Pp1Package.IF_EXPRESSION__THEN_STATEMENTS);
		}
	...
	public NotificationChain basicSetElseStatement(Expression newElseStatement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pp1Package.IF_EXPRESSION__ELSE_STATEMENT, oldElseStatement, newElseStatement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElseStatement(Expression newElseStatement) {
		if (newElseStatement != elseStatement) {
			...
			if (elseStatement != null)
				msgs = ((InternalEObject)elseStatement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pp1Package.IF_EXPRESSION__ELSE_STATEMENT, null, msgs);
			if (newElseStatement != null)
				msgs = ((InternalEObject)newElseStatement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pp1Package.IF_EXPRESSION__ELSE_STATEMENT, null, msgs);
			msgs = basicSetElseStatement(newElseStatement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.IF_EXPRESSION__ELSE_STATEMENT, newElseStatement, newElseStatement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.IF_EXPRESSION__COND_EXPR:
				return basicSetCondExpr(null, msgs);
			case Pp1Package.IF_EXPRESSION__THEN_STATEMENTS:
				return ((InternalEList<?>)getThenStatements()).basicRemove(otherEnd, msgs);
			case Pp1Package.IF_EXPRESSION__ELSE_STATEMENT:
