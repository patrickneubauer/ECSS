...
import pp1.AdditiveExpression;
import pp1.AndExpression;
import pp1.AppendExpression;
import pp1.AssignmentExpression;
import pp1.AtExpression;
import pp1.AttributeOperation;
import pp1.AttributeOperations;
import pp1.BinaryExpression;
...
import pp1.ElseExpression;
import pp1.ElseIfExpression;
import pp1.EqualityExpression;
import pp1.ExportedCollectQuery;
import pp1.ExprList;
import pp1.Expression;
import pp1.ExpressionBlock;
import pp1.ExpressionTE;
import pp1.FunctionCall;
import pp1.HashEntry;
import pp1.HostClassDefinition;
import pp1.ICollectQuery;
import pp1.IQuotedString;
import pp1.IfExpression;
import pp1.ImportExpression;
import pp1.InExpression;
import pp1.InterpolatedVariable;
import pp1.JavaLambda;
import pp1.Lambda;
import pp1.LiteralBoolean;
import pp1.LiteralClass;
import pp1.LiteralDefault;
import pp1.LiteralExpression;
import pp1.LiteralHash;
import pp1.LiteralList;
import pp1.LiteralName;
import pp1.LiteralNameOrReference;
import pp1.LiteralRegex;
import pp1.LiteralUndef;
import pp1.MatchingExpression;
import pp1.MethodCall;
import pp1.MultiplicativeExpression;
import pp1.NamedAccessExpression;
import pp1.NodeDefinition;
import pp1.OrExpression;
import pp1.ParameterizedExpression;
import pp1.ParenthesisedExpression;
import pp1.Pp1Factory;
import pp1.Pp1Package;
import pp1.PuppetManifest;
import pp1.RelationalExpression;
import pp1.RelationshipExpression;
import pp1.ResourceBody;
import pp1.ResourceExpression;
import pp1.RubyLambda;
import pp1.SelectorEntry;
import pp1.SelectorExpression;
import pp1.SeparatorExpression;
import pp1.ShiftExpression;
import pp1.SingleQuotedString;
import pp1.StringExpression;
import pp1.TextExpression;
import pp1.UnaryExpression;
import pp1.UnaryMinusExpression;
import pp1.UnaryNotExpression;
import pp1.UnlessExpression;
import pp1.UnquotedString;
import pp1.VariableExpression;
import pp1.VariableTE;
import pp1.VerbatimTE;
 ...
 * @generated
 */
public class Pp1PackageImpl extends EPackageImpl implements Pp1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see pp1.Pp1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Pp1PackageImpl() {
		super(eNS_URI, Pp1Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Pp1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Pp1Package init() {
		if (isInited) return (Pp1Package)EPackage.Registry.INSTANCE.getEPackage(Pp1Package.eNS_URI);

		// Obtain or create and register package
		Object registeredPp1Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Pp1PackageImpl thePp1Package = registeredPp1Package instanceof Pp1PackageImpl ? (Pp1PackageImpl)registeredPp1Package : new Pp1PackageImpl();

		isInited = true;

		// Create package meta-data objects
		thePp1Package.createPackageContents();

		// Initialize created meta-data
		thePp1Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		thePp1Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Pp1Package.eNS_URI, thePp1Package);
		return thePp1Package;
	}
	 ...
	 */
	@Override
	public Pp1Factory getPp1Factory() {
		return (Pp1Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDefinition_Statements(), this.getExpression(), null, "statements", null, 0, -1, Definition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCase_Statements(), this.getExpression(), null, "statements", null, 0, -1, Case.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIfExpression_ThenStatements(), this.getExpression(), null, "thenStatements", null, 0, -1, IfExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNodeDefinition_Statements(), this.getExpression(), null, "statements", null, 0, -1, NodeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUnlessExpression_ThenStatements(), this.getExpression(), null, "thenStatements", null, 0, -1, UnlessExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
