 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.LiteralHashImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralHashImpl extends LiteralExpressionImpl implements LiteralHash {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.LITERAL_HASH;
	}
	...
	public EList<HashEntry> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<HashEntry>(HashEntry.class, this, Pp1Package.LITERAL_HASH__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.LITERAL_HASH__ELEMENTS:
