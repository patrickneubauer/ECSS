 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.DefinitionArgumentListImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionArgumentListImpl extends MinimalEObjectImpl.Container implements DefinitionArgumentList {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.DEFINITION_ARGUMENT_LIST;
	}
	...
	public EList<DefinitionArgument> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<DefinitionArgument>(DefinitionArgument.class, this, Pp1Package.DEFINITION_ARGUMENT_LIST__ARGUMENTS);
		}
		return arguments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.DEFINITION_ARGUMENT_LIST__ARGUMENTS:
