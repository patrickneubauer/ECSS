 ...
 * </p>
 * <ul>
 *   <li>{@link pp1.impl.MethodCallImpl#isParenthesized <em>Parenthesized</em>}</li>
 *   <li>{@link pp1.impl.MethodCallImpl#getMethodExpr <em>Method Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodCallImpl extends WithLambdaExpressionImpl implements MethodCall {
	...
	protected EClass eStaticClass() {
		return Pp1Package.Literals.METHOD_CALL;
	}
	...
	public void setParenthesized(boolean newParenthesized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.METHOD_CALL__PARENTHESIZED, oldParenthesized, parenthesized));
	}
	...
	public NotificationChain basicSetMethodExpr(Expression newMethodExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Pp1Package.METHOD_CALL__METHOD_EXPR, oldMethodExpr, newMethodExpr);
	...
	public void setMethodExpr(Expression newMethodExpr) {
		if (newMethodExpr != methodExpr) {
			...
			if (methodExpr != null)
				msgs = ((InternalEObject)methodExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Pp1Package.METHOD_CALL__METHOD_EXPR, null, msgs);
			if (newMethodExpr != null)
				msgs = ((InternalEObject)newMethodExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Pp1Package.METHOD_CALL__METHOD_EXPR, null, msgs);
			msgs = basicSetMethodExpr(newMethodExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Pp1Package.METHOD_CALL__METHOD_EXPR, newMethodExpr, newMethodExpr));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Pp1Package.METHOD_CALL__METHOD_EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Pp1Package.METHOD_CALL__PARENTHESIZED:
