 ...
 * </p>
 * <ul>
 *   <li>{@link xturtle.impl.DirectiveImpl#getUri <em>Uri</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DirectiveImpl extends MinimalEObjectImpl.Container implements Directive {
	...
	protected EClass eStaticClass() {
		return XturtlePackage.Literals.DIRECTIVE;
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XturtlePackage.DIRECTIVE__URI, oldUri, uri));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XturtlePackage.DIRECTIVE__URI:
				return getUri();
		}
