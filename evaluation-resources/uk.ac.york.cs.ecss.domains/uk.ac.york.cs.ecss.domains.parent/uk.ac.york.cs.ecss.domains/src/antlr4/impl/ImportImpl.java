 ...
 * </p>
 * <ul>
 *   <li>{@link antlr4.impl.ImportImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link antlr4.impl.ImportImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportImpl extends MinimalEObjectImpl.Container implements Import {
	...
	protected EClass eStaticClass() {
		return Antlr4Package.Literals.IMPORT;
	}
	...
	public void setAlias(String newAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Antlr4Package.IMPORT__ALIAS, oldAlias, alias));
	}
	...
	public Grammar getImportURI() {
		if (importURI != null && importURI.eIsProxy()) {
			...
			if (importURI != oldImportURI) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Antlr4Package.IMPORT__IMPORT_URI, oldImportURI, importURI));
			}
		}
		return importURI;
	}
	...
	public void setImportURI(Grammar newImportURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Antlr4Package.IMPORT__IMPORT_URI, oldImportURI, importURI));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Antlr4Package.IMPORT__ALIAS:
				return getAlias();
			case Antlr4Package.IMPORT__IMPORT_URI:
