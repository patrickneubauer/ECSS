 ...
 * </p>
 * <ul>
 *   <li>{@link antlr4.impl.LexerAltListImpl#getAlternatives <em>Alternatives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LexerAltListImpl extends MinimalEObjectImpl.Container implements LexerAltList {
	...
	protected EClass eStaticClass() {
		return Antlr4Package.Literals.LEXER_ALT_LIST;
	}
	...
	public EList<LexerAlt> getAlternatives() {
		if (alternatives == null) {
			alternatives = new EObjectContainmentEList<LexerAlt>(LexerAlt.class, this, Antlr4Package.LEXER_ALT_LIST__ALTERNATIVES);
		}
		return alternatives;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Antlr4Package.LEXER_ALT_LIST__ALTERNATIVES:
