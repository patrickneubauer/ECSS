...
public class YangPackageImpl extends EPackageImpl implements YangPackage {
	...
	public static YangPackage init() {
		...
		Object registeredYangPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		YangPackageImpl theYangPackage = registeredYangPackage instanceof YangPackageImpl ? (YangPackageImpl)registeredYangPackage : new YangPackageImpl();
	...
	protected void fixInstanceClass(EClassifier eClassifier) {
		if (eClassifier.getInstanceClassName() == null) {
			eClassifier.setInstanceClassName("yang." + eClassifier.getName());
