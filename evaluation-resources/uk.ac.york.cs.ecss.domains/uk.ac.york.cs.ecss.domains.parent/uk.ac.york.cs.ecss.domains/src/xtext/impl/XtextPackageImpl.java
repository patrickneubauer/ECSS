...
import xtext.AbstractNegatedToken;
import xtext.AbstractRule;
import xtext.Action;
import xtext.Alternatives;
import xtext.Annotation;
import xtext.Assignment;
import xtext.CharacterRange;
import xtext.CompositeCondition;
import xtext.CompoundElement;
import xtext.Condition;
import xtext.Conjunction;
import xtext.CrossReference;
import xtext.Disjunction;
import xtext.EnumLiteralDeclaration;
import xtext.EnumRule;
import xtext.GeneratedMetamodel;
import xtext.Grammar;
import xtext.Group;
import xtext.Keyword;
import xtext.LiteralCondition;
import xtext.NamedArgument;
import xtext.NegatedToken;
import xtext.Negation;
import xtext.Parameter;
import xtext.ParameterReference;
import xtext.ParserRule;
import xtext.ReferencedMetamodel;
import xtext.RuleCall;
import xtext.TerminalRule;
import xtext.TypeRef;
import xtext.UnorderedGroup;
import xtext.UntilToken;
import xtext.Wildcard;
import xtext.XtextFactory;
import xtext.XtextPackage;
...
public class XtextPackageImpl extends EPackageImpl implements XtextPackage {
	 ...
	 * @see xtext.XtextPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(eofEClass, xtext.EOF.class, "EOF", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
