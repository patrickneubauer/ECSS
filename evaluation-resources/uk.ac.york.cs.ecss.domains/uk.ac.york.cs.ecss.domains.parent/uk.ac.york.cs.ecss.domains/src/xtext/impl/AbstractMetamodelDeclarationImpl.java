 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.impl.AbstractMetamodelDeclarationImpl#getEPackage <em>EPackage</em>}</li>
 *   <li>{@link xtext.impl.AbstractMetamodelDeclarationImpl#getAlias <em>Alias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractMetamodelDeclarationImpl extends MinimalEObjectImpl.Container implements AbstractMetamodelDeclaration {
		...
		if (ePackage != null && ePackage.eIsProxy()) {
			...
			if (ePackage != oldEPackage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextPackage.ABSTRACT_METAMODEL_DECLARATION__EPACKAGE, oldEPackage, ePackage));
			}
		}
		return ePackage;
	}
	...
	public void setEPackage(EPackage newEPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtextPackage.ABSTRACT_METAMODEL_DECLARATION__EPACKAGE, oldEPackage, ePackage));
	}
