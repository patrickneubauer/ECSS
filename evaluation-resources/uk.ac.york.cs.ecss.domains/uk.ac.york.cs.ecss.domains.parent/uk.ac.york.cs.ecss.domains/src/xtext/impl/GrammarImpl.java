 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.impl.GrammarImpl#getName <em>Name</em>}</li>
 *   <li>{@link xtext.impl.GrammarImpl#getUsedGrammars <em>Used Grammars</em>}</li>
 *   <li>{@link xtext.impl.GrammarImpl#isDefinesHiddenTokens <em>Defines Hidden Tokens</em>}</li>
 *   <li>{@link xtext.impl.GrammarImpl#getHiddenTokens <em>Hidden Tokens</em>}</li>
 *   <li>{@link xtext.impl.GrammarImpl#getMetamodelDeclarations <em>Metamodel Declarations</em>}</li>
 *   <li>{@link xtext.impl.GrammarImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
