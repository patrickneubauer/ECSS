 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.impl.ActionImpl#getType <em>Type</em>}</li>
 *   <li>{@link xtext.impl.ActionImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link xtext.impl.ActionImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends AbstractElementImpl implements Action {
	...
	public void setType(TypeRef newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextPackage.ACTION__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextPackage.ACTION__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtextPackage.ACTION__TYPE, newType, newType));
	}
