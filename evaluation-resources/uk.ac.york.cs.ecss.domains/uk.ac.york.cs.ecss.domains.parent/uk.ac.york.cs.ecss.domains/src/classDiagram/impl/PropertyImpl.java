 ...
 * </p>
 * <ul>
 *   <li>{@link classDiagram.impl.PropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link classDiagram.impl.PropertyImpl#isOptional <em>Optional</em>}</li>
 *   <li>{@link classDiagram.impl.PropertyImpl#getType <em>Type</em>}</li>
 *   <li>{@link classDiagram.impl.PropertyImpl#getEntityList <em>Entity List</em>}</li>
 *   <li>{@link classDiagram.impl.PropertyImpl#isConstant <em>Constant</em>}</li>
 *   <li>{@link classDiagram.impl.PropertyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
