 ...
 * @generated
 */
public class Module2Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Module2Package.JSON_OBJECT: {
			...
			case Module2Package.JSON_METADATA: {
			...
			case Module2Package.PAIR: {
				Pair pair = (Pair)theEObject;
				T result = casePair(pair);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Module2Package.UNRECOGNIZED_PAIR: {
			...
			case Module2Package.JSON_ARRAY: {
			...
			case Module2Package.JSON_DEPENDENCY: {
			...
			case Module2Package.METADATA_REF_PAIR: {
			...
			case Module2Package.JSON_REQUIREMENT: {
			...
			case Module2Package.JSON_VALUE: {
			...
			case Module2Package.REQUIREMENT_NAME_VALUE: {
			...
			case Module2Package.JSON_VERSION_RANGE: {
			...
			case Module2Package.JSON_MODULE_NAME: {
			...
			case Module2Package.JSON_VERSION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Metadata Ref Pair</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Metadata Ref Pair</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
