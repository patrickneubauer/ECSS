 ...
 * </p>
 * <ul>
 *   <li>{@link module2.impl.JsonArrayImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JsonArrayImpl extends ValueImpl implements JsonArray {
	...
	protected EClass eStaticClass() {
		return Module2Package.Literals.JSON_ARRAY;
	}
	...
	public EList<Value> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<Value>(Value.class, this, Module2Package.JSON_ARRAY__VALUE);
		}
		return value;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Module2Package.JSON_ARRAY__VALUE:
