 ...
 * </p>
 * <ul>
 *   <li>{@link module2.impl.JsonObjectImpl#getPairs <em>Pairs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JsonObjectImpl extends ValueImpl implements JsonObject {
	...
	protected EClass eStaticClass() {
		return Module2Package.Literals.JSON_OBJECT;
	}
	...
	public EList<Pair> getPairs() {
		if (pairs == null) {
			pairs = new EObjectContainmentEList<Pair>(Pair.class, this, Module2Package.JSON_OBJECT__PAIRS);
		}
		return pairs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Module2Package.JSON_OBJECT__PAIRS:
