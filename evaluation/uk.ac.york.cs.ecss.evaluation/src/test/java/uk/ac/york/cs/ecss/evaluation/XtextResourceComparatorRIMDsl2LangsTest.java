...
public class XtextResourceComparatorRIMDsl2LangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = RIMDslPackage.eINSTANCE;
	...
	public void loadSrcLangModels() {
		Injector srcLangInj = new srclang.com.temenos.interaction.rimdsl.RIMDslStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.temenos.interaction.rimdsl.RIMDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.com.temenos.interaction.rimdsl.RIMDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.temenos.interaction.rimdsl.RIMDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.com.temenos.interaction.rimdsl.RIMDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
