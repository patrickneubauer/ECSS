...
public class XtextResourceComparatorPP1LangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = Pp1Package.eINSTANCE;
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.puppetlabs.geppetto.pp.dsl1.PPStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.com.puppetlabs.geppetto.pp.dsl1.PPStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.puppetlabs.geppetto.pp.dsl1.PPStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.com.puppetlabs.geppetto.pp.dsl1.PPStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
