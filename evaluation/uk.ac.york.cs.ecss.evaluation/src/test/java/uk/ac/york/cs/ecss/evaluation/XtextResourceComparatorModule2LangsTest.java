...
public class XtextResourceComparatorModule2LangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = Module2Package.eINSTANCE;
	...
	public void loadSrcLangModels() {
		Injector srcLangInj = new srclang.com.puppetlabs.geppetto.module2.dsl.Module2StandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.puppetlabs.geppetto.module2.dsl.Module2StandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.com.puppetlabs.geppetto.module2.dsl.Module2StandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.puppetlabs.geppetto.module2.dsl.Module2StandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.com.puppetlabs.geppetto.module2.dsl.Module2StandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
