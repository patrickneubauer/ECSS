...
public class XtextResourceComparatorWollokDslLangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = WollokDslPackage.eINSTANCE;
	...
	public void loadSrcLangModels() {
		Injector srcLangInj = new srclang.org.uqbar.project.wollok.WollokDslStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.org.uqbar.project.wollok.WollokDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.org.uqbar.project.wollok.WollokDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.org.uqbar.project.wollok.WollokDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.org.uqbar.project.wollok.WollokDslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
