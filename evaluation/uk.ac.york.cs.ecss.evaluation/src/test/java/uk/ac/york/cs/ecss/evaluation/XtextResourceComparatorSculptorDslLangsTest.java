...
public class XtextResourceComparatorSculptorDslLangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = SculptordslPackage.eINSTANCE;
		EPackage.Registry.INSTANCE.put(pkg.getNsURI(), pkg);
		langName = "SculptorDsl";
	...
	public void loadSrcLangModels() {
		Injector srcLangInj = new srclang.org.sculptor.dsl.SculptordslStandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.org.sculptor.dsl.SculptordslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.org.sculptor.dsl.SculptordslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.org.sculptor.dsl.SculptordslStandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.org.sculptor.dsl.SculptordslStandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
