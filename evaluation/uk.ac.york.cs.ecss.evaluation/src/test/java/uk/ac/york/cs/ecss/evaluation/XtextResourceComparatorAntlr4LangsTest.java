...
public class XtextResourceComparatorAntlr4LangsTest extends XtextResourceComparatorBaseTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		EPackage pkg = Antlr4Package.eINSTANCE;
	...
	public void loadSrcLangModels() {
		Injector srcLangInj = new srclang.com.github.jknack.antlr4ide.Antlr4StandaloneSetup().createInjectorAndDoEMFRegistration();
	...
	public void serializeDefLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.github.jknack.antlr4ide.Antlr4StandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector defLangInj = new deflang.com.github.jknack.antlr4ide.Antlr4StandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
	...
	public void serializeTrgLangModels() throws IOException {
		Injector srcLangInj = new srclang.com.github.jknack.antlr4ide.Antlr4StandaloneSetup().createInjectorAndDoEMFRegistration();
		Injector trgLangInj = new trglang.com.github.jknack.antlr4ide.Antlr4StandaloneSetup().createInjectorAndDoEMFRegistration();
		String basePath = "models/" + langName + "/";
