...
public class MyTestWsBasicAO {
	
	public static void main(String[] args) {
		final String ECORE_PATH = "D:\\dev\\ECSS\\data-example\\";
		final String ECORE_FILE_NAME = "spacetransportationservice.ecore";
		File ecssModelFile = new File("D:\\dev\\ECSS\\styles\\wsawarebasicao.ecss");
		File metamodelFile = new File(ECORE_PATH + ECORE_FILE_NAME);
		File xtextGrammarFile = new File(ECORE_PATH + ECORE_FILE_NAME.replace(".ecore", "_BASICAO_"+new Date().getTime()+".xtext"));
