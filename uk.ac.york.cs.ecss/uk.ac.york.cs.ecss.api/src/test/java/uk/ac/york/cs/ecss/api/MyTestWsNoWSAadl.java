...
public class MyTestWsNoWSAadl {
	
	public static void main(String[] args) {
		final String ECORE_PATH = "model\\";
		final String ECORE_FILE_NAME = "aadl2.ecore";
		File ecssModelFile = new File("D:\\dev\\ECSS\\styles\\wsawarenows.ecss");
		File metamodelFile = new File(ECORE_PATH + ECORE_FILE_NAME);
		File xtextGrammarFile = new File(ECORE_PATH + ECORE_FILE_NAME.replace(".ecore", "_GENNOWS_"+new Date().getTime()+".xtext"));
