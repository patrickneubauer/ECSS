...
public class ExampleCaseWsBasicAO {
	...
	public static void main(String[] args) {
		...
		File ecssModelFile = new File(STYLE_PATH + "wsawarebasicao.ecss");
		File metamodelFile = new File(ECORE_PATH + ECORE_FILE_NAME);
		File xtextGrammarFile = new File(ECORE_PATH + ECORE_FILE_NAME.replace(".ecore", "_GENBASICAO_"+new Date().getTime()+".xtext"));
