...
public class MyTestNoAoBasic {
	
	public static void main(String[] args) {
		final String ECORE_PATH = "D:\\dev\\ECSS\\data-example\\";
		final String ECORE_FILE_NAME = "spacetransportationservice.ecore";
		File ecssModelFile = new File("D:\\dev\\ECSS\\styles\\wsawarebasicsq.ecss");
		File metamodelFile = new File(ECORE_PATH + ECORE_FILE_NAME);
		File xtextGrammarFile = new File(ECORE_PATH + ECORE_FILE_NAME.replace(".ecore", "_NOAOBASIC_"+new Date().getTime()+".xtext"));
