...
public class GrammarCreatorDataExampleTest {

	private static final Logger logger = LogManager.getLogger(GrammarCreatorDataExampleTest.class);
	...
	private void runGrammarGenerator(String baseFolder, String ecoreFileName, String ecssFileName) throws IOException {
		File ecoreFile = new File(baseFolder + ECORE_INPUT_PATH + ecoreFileName + "." + METAMODEL_FILE_EXTENSION);
...
//		grammarCreator.generateGrammar();
	...
	public GrammarCreatorDataExampleTest(File inputFile) {
