...
public class EclipsePluginXtextProjectCreatorTest extends BaseXtextProjectCreatorTest {
	...
	public void testHeroLanguage_1() {
		...
		BaseXtextProjectCreator projectCreator = new EclipsePluginXtextProjectCreator(EXAMPLE_DATA_FOLDER + REPORT_FILE_LOCATION, projectBaseName, languageName, fileExtensions);
